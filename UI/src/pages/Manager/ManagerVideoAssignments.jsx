        ...
        <div className="space-y-4">
          ...
          {showAddForm && (
            <form onSubmit={handleAddVideo} className="bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4">
              <div className="flex justify-between items-center">
                <h3 className="font-semibold text-gray-800 text-sm">New Video</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">Video URL * <span className="text-gray-400 font-normal">(YouTube or direct link)</span></label>
                  <input
                    required
          ...
          {videos.length === 0 ? (
            <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
              ...
              <p className="text-gray-500 text-sm">No videos yet. Add one to get started.</p>
            </div>
          ) : (
